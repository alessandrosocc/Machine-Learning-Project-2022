...
def kNN(trasformazione, modifica, bilanciamento):
    X, y, dataType, features = csv_open(trasformazione, modifica, bilanciamento) #Utilizzando la funzione csv_open andiamo a prendere i dati del dataset per utilizzarli in questo classificatore
